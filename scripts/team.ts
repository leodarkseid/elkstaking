...
import { Elk__factory, TeamVester__factory } from "../typechain-types";
...
async function main() {
    ...
    const TMFactory = new TeamVester__factory(signer[0]);
    ...
    const amountAvailable = await contract.getAmountAvailable();
    ...
    const amountAvailable2 = await contract.getAmountAvailable();
    ...
    const amountAvailable3 = await contract.getAmountAvailable();
